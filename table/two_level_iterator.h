...
struct ReadOptions;
//unsigned char HashKtoTN[200000000][12];
...
// an iterator over the contents of the corresponding block.
  //extern unsigned char HashKtoTN[200000000][12];
...
/*extern Iterator* NewTwoLevelIterator2(
    Iterator* index_iter,
    Iterator* (*block_function)(
        void* arg,
        const ReadOptions& options,
...
extern Iterator* TwoLevelCountInValidKey(
    Iterator* index_iter,
    Iterator* (*block_function)(
        void* arg,
        const ReadOptions& options,
