...
class Repairer {
 ...
 private:
  ...
  Iterator* NewTableIterator(const FileMetaData& meta) {
    ...
    return table_cache_->NewIterator(r, meta.number, meta.file_size,false,false);
  }
  ...
  void RepairTable(const std::string& src, TableInfo t) {
    ...
    TableBuilder* builder = new TableBuilder(options_, file, true, 10);
  ...
  Status WriteDescriptor() {
    ...
    for (size_t i = 0; i < tables_.size(); i++) {
      ...
      edit_.AddFile(0, t.meta.number, t.meta.partition,t.meta.file_size,
