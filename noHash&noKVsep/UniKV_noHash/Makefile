...
CFLAGS +=-pthread -I. -I./include $(PLATFORM_CCFLAGS) $(OPT) 
CXXFLAGS += -I. -I./include $(PLATFORM_CXXFLAGS) $(OPT)

LDFLAGS += $(PLATFORM_LDFLAGS) -lrt
LIBS += $(PLATFORM_LIBS) -lrt
...
SHARED_LIB1 = libunikv.$(PLATFORM_SHARED_EXT)
...
all: $(SHARED_LIBS) $(SHARED_PROGRAMS) $(STATIC_OUTDIR)/libunikv.a $(STATIC_OUTDIR)/libmemenv.a $(STATIC_PROGRAMS)
...
ifeq ($(PLATFORM), IOS)
$(DEVICE_OUTDIR)/libunikv.a: $(DEVICE_LIBOBJECTS)
	rm -f $@
	$(AR) -rs $@ $(DEVICE_LIBOBJECTS)

$(SIMULATOR_OUTDIR)/libunikv.a: $(SIMULATOR_LIBOBJECTS)
	rm -f $@
...
# a device.
$(STATIC_OUTDIR)/libunikv.a: $(STATIC_OUTDIR) $(DEVICE_OUTDIR)/libunikv.a $(SIMULATOR_OUTDIR)/libunikv.a
	lipo -create $(DEVICE_OUTDIR)/libunikv.a $(SIMULATOR_OUTDIR)/libunikv.a -output $@
...
$(STATIC_OUTDIR)/libunikv.a:$(STATIC_LIBOBJECTS)
	rm -f $@
...
$(STATIC_OUTDIR)/memenv_test:$(STATIC_OUTDIR)/helpers/memenv/memenv_test.o $(STATIC_OUTDIR)/libmemenv.a $(STATIC_OUTDIR)/libunikv.a $(TESTHARNESS)
	$(XCRUN) $(CXX) $(LDFLAGS) $(STATIC_OUTDIR)/helpers/memenv/memenv_test.o $(STATIC_OUTDIR)/libmemenv.a $(STATIC_OUTDIR)/libunikv.a $(TESTHARNESS) -o $@ $(LIBS)
